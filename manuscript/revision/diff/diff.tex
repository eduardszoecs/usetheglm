...
%DIF ADD revision/report/report.tex     Mon Mar 16 12:48:44 2015
...
\begin{figure*}
  ...
  \caption{Count data simulations \DIFdelbeginFL \DIFdelFL{: Power }\DIFdelendFL (\DIFdelbeginFL \DIFdelFL{top}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{n = 1000}\DIFaddendFL )\DIFdelbeginFL \DIFdelFL{and }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{: }\DIFaddendFL Type 1 error (\DIFaddbeginFL \DIFaddFL{top) and Power (}\DIFaddendFL bottom) for the test of a treatment effect.
...
The power to detect the LOEC was highest for $GLM_{nb}$ and \DIFdelbegin \DIFdel{$GLM_{npb}$}\DIFdelend \DIFaddbegin \DIFadd{$GLM_{qp}$}\DIFaddend . $LM$ and WT showed less power, with WT having no power to detect the LOEC at low sample sizes.
...
\begin{figure*}
  ...
  \DIFaddbeginFL \DIFaddFL{Only type 1 errors \textless 25\% are displayed.
  }\DIFaddendFL For n = \DIFaddbeginFL \DIFaddFL{\{}\DIFaddendFL 3\DIFaddbeginFL \DIFaddFL{, 6\} }\DIFaddendFL and $\mu_C$ = \{2, 4\} less than \DIFdelbeginFL \DIFdelFL{80}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{85}\DIFaddendFL \% of $GLM_{nb}$ \DIFdelbeginFL \DIFdelFL{and $GLM_{npb}$ }\DIFdelendFL models did converge.
  Dashed horizontal line denotes the nominal Type 1 error rate at $\alpha = 0.05$.
  }
  \label{fig:p_loec_c}
\end{figure*}
