...
\begin{figure*}
  ...
  \caption{Count data simulations (n = 1000): Type 1 error (top) and Power (bottom) for the test of a treatment effect.
...
The power to detect the LOEC was highest for $GLM_{nb}$ and $GLM_{qp}$. $LM$ and WT showed less power, with WT having no power to detect the LOEC at low sample sizes.
