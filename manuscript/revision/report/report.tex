...
Here, we compare the performance of analyses using transformed data, non-parametric methods and GLMs.

We simulated data mimicking ecotoxicological experiments of two common data types (counts and proportions from counts). 
...
GLMs should become a standard method in ecotoxicology. \todo{letzter absatz noch überarbeiten...}
...
We recommend that counts or proportions from counts in ecotoxicologal experiments should be analysed by GLMs and not by transformations or non-parametric methods.
