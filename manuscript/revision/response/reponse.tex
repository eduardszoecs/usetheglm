...
\todo{nb biased -> parametric bootstrap!}
...
\response{We agree and revised our manuscript accordingly. We changed the subtitle (see also comment 2) and the abstract \todo{abstract fertig machen} (see also comment 21). The main text is now more specific to counts and proportions from counts.}
