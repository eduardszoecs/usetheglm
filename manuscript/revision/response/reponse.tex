...
For the submission we did not use Holm's method for the binomial data simulations. However, we unified this with the rerun of simulations (see comment 14) \todo{discussion}.}
...
Our simulations mimicked the data of the case study and we clarified this.
\todo{Williams}
}
...
\response{We agree and added a discussion of backtransformation bias. See also comments 4 and 44.}
