...
% macros
\newcommand{\comment}[1]{\vspace{1.5em} \noindent \hangindent=0em \textbf{\textcolor{Maroon}{\uline{Comment}:~}}\emph{"#1"} }

\newcommand{\response}[1]{\\[0.2em] \hangindent=2.3em \textbf{\textcolor{NavyBlue}{\uline{Response}:~}}#1}
