...
%DIF ADD revision2/report/report.tex   Thu Apr 16 19:13:38 2015
...
\DIFadd{The choice of transformation contributed only little to the differences. 
}

\DIFadd{A much bigger impact had the type of multiple comparison: 
}\DIFaddend In contrast to the Williams test, Dunnett contrasts do not assume a monotonic dose-response relationship and allow individual comparisons between treatment groups and the control.
