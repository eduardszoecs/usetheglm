...
\todo{Nicht nochmal den selben text! - d.h. ersten Absatz neu.}
\vspace{2em}
\hfill Kind regards,
...
\comment{p1 col1 l46 extremely}
\response{}

\comment{p2 col2 l1 for more than 40}
\response{}

\comment{p2 col1 l7 Warton 2005 was about counts not proportions.}
\response{}
...
\comment{p4 col2 l18: considerably higher}
\response{}

\comment{p4 col2 l21: led to}
\response{}

\comment{p4 col2 l50 the parameteric bootstrap}
\response{}
...
\comment{p8 col 1 line 7 delete "to"}
\response{}

\comment{p8 col2 line 1 add space after 2002)}
\response{}
