...
6 treatments (Control, n = 4; 0.1 mg/L, 0.3mg/L, 1mg/L, 3mg/L, n = 3; 10 mg/L, n = 2) within 18 mesocosms have been sampled. \todo{unübersichtlich}
...
This data set is provided the textbook of \citet{newman_quantitative_2012}.
...
, where $y_i^T$ are the transformed proportions and N is the number of exposed animals per treatment (= 10).
...
The global tests of both methods indicated a effect of NaPCP on larval survival (linear model: F = 20.51, p \textless 0.001; GLM: LR = 64.79, p \textless 0.001).
...
Control ($\alpha$) & 1.249 & (1.134, 1.364) & 2.994 & (1.523, 4.366) \\ 
32 \textmu g/L  & -0.106 & (-0.269, 0.056) & -1.21 & (2.876, 0.456) \\ 
64 \textmu g/L  & 0.000 & (-0.162, 0.162) & 0.719 & (-1.723, 3.161) \\ 
128 \textmu g/L  & -0.035 & (-0.198, 0.127) & -0.747 & (-2.505, 1.010) \\ 
256 \textmu g/L & -0.180 & (-0.343, -0.018) & -1.708 & (-3.312, -0.104) \\ 
512 \textmu g/L  & -0.646 & (-0.808, -0.484)$*$ & -3.675 & (-5.244, -2.107)$*$ \\ 
\hline
\end{tabular}
\end{table}
