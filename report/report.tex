...
\cgititet{brock_minimum_2014} provides a typical example data from a mesocosm study of mayfly larvae counts on artificial substrate samplers at one sampling day (Figure \ref{fig:example}). 
...
The model selection process can be guided by the data and diagnostic plots and, therefore, is much more sound then choosing between transformations.
...
GLMs should become a standard method in ecotoxicolgy and guidelines need to be updated accordingly.
