...
The global tests of both methods indicated a strong effect of NaPCP on larval survival (linear model: F = 20.51, p \textless 0.001; GLM: LR = 64.79, p \textless 0.001).
