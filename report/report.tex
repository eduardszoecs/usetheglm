...
However, the coefficients of the binomial model are directly interpretable as change in the odds ratio:
In the control group the odds of death are 1:20 ($e^{2.994}$), 
\todo{further elaborate}

 whereas this is not possible with the transformed data (Table \ref{tab:ex_bin}).
...
\todo{explain parameters = change in log odds.}
