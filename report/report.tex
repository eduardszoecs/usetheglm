...
Because of overdispersion the Poisson model did not fit to the data and inferences are not valid. \todo{see supplement}
...
We showed for two common data types in ecotoxicolgy, that using an appropriate model yielded higher statistical power, than trying to meet the assumptions of normality and variance homogeneity using transformations.


%% ------ Multivariate + GLMM -------
Although, our simulations covered only simple exerimental designs, these findings may also extend to more complex designs. 
...
In contrast our results show that 
...
\todo{Kritik an NOEC}
\todo{No wilcox/kruskal - maybe more sophisticated non-parametric approaches!}
\todo{wang riffel}
